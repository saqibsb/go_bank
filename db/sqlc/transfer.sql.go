...
RETURNING id, from_acount_id, to_account_id, amount, created_at
`
...
func (q *Queries) CreateTransfer(ctx context.Context, arg CreateTransferParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, createTransfer, arg.Amount, arg.FromAcountID, arg.ToAccountID)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAcountID,
...
SELECT id, from_acount_id, to_account_id, amount, created_at FROM transfers
WHERE id = $1 LIMIT 1
`
...
func (q *Queries) UpdateTransfer(ctx context.Context, arg UpdateTransferParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, updateTransfer, arg.ID, arg.Amount, arg.FromAcountID)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAcountID,
